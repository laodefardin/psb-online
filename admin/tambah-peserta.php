...
if (isset($_POST['submit'])) {
  ...
  //   `jalur`     = "'.$jalur.'"
  //   WHERE `id` = "'.$id_peserta.'"');
$password = sha1($nama_lengkap);
$waktu = gmdate('d-m-Y H:i:s', time()+60*60*8);
$sql = $koneksi->query('INSERT INTO peserta (nama_lengkap, alamat, tempat_lahir, tanggal_lahir, jk, agama, no_hp, sekolah_asal, tahun_lulus, nama_ayah, pk_ayah, nama_ibu, pk_ibu, alamat_ortu, hp_ortu, pilihan_1, pilihan_2, registrasi, jalur, username, password, level, waktu) VALUES ("'.$nama_lengkap.'","'.$alamat.'","'.$tempat_lahir.'","'.$tanggal_lahir.'","'.$jk.'","'.$agama.'","'.$no_hp.'","'.$sekolah_asal.'","'.$tahun_lulus.'","'.$nama_ayah.'","'.$pk_ayah.'","'.$nama_ibu.'","'.$pk_ibu.'","'.$alamat_ortu.'","'.$hp_ortu.'","'.$pilihan_1.'","'.$pilihan_2.'","selesai","'.$jalur.'","'.$nama_lengkap.'","'.$password.'","peserta","'.$waktu.'")');
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Sesuai Ijasah" required> 
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" placeholder="Contoh 14-07-1996" name="tanggal_lahir" class="form-control">
                      </div>
                    </div>
                    <div class="col-sm-3 col-md-3">
                      <div class="form-group">
