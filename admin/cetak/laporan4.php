...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
	...
	<tr>
		<td style='border:hidden;text-align:center;font-weight:bold' colspan='11'>DAFTAR PESERTA JALUR KHUSUS YANG SUDAH REGISTRASI</td>
	</tr>
</table>
<table width="98%" border="1" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
	...
	<tr>
		<?php
		$result = $koneksi->query("SELECT * FROM peserta WHERE registrasi = 'selesai' AND jalur = 'Khusus' ORDER BY nama_lengkap ASC");
