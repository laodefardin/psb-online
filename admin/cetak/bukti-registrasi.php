...
<body onload="window.print()">
	...
	session_start();
	include '../../koneksi.php';
	$id_peserta = isset($_GET['cetak'])?$_GET['cetak'] *1:0;
	...
	<table width="98%">
		...
		<table width="98%" border="0" align="center" cellpadding="5" cellspacing=0 style='border-collapse:collapse;margin:0 auto'>
			<?php 
			$result = $koneksi->query("SELECT * FROM peserta WHERE id = '$_GET[cetak]'");
			...
			<tr>
				<td style='border:hidden' colspan='14'>Silahkan membawa bukti registrasi ini saat pengambilan Kartu Ujian Tanggal 27 - 29 Juni 2019</td>
			</tr>
			<tr>
			</tr>
		<?php } ?>
