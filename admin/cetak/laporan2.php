...
<table width="98%" border="1" align="center" cellpadding="5" cellspacing="2" style='border-collapse:collapse;margin:0 auto'>
	...
	<tr>
		<?php
		$result = $koneksi->query("SELECT * FROM peserta WHERE registrasi = 'selesai' AND pilihan_1 = 'Teknik Bisnis Sepeda Motor' AND pilihan_2 = 'Teknik Pengelasan' ORDER BY nama_lengkap ASC");
