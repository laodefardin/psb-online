      ...
      <div class="col-lg order-lg-first">
        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a href="user" class="nav-link active"><i class="fe fe-printer mr-2"></i> User</a>
          </li>
          <li class="nav-item">
    ...
    // tampilkan pesan error jika ada
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Daftar UserCalon Peserta Didik Baru</h3>
        </div>
        <div class="table-responsive">
          <?php 
          $query = $koneksi->query("SELECT * FROM peserta");
          ?>
