...
if (isset($_POST['submit'])) {
  ...
  $query = $koneksi->query("UPDATE `pengumuman` SET 
    `judul_pengumuman` = '$judul_pengumuman',
    `isi_pengumuman` = '$isi_pengumuman' WHERE `id_pengumuman` = '$id_pengumuman'");
  ...
  <div class="container">
   <div class="row row-cards">
    ...
    // tampilkan pesan error jika ada
      ...
      <div class="card-body">
        <?php 
        $query = $koneksi->query("SELECT * FROM pengumuman WHERE id_pengumuman = '$id_pengumuman'");
          ...
          <form action="" method="post">
            <div class="form-group">
              <div class="row align-items-center">
                ...
                <div class="col-sm-10">
                  <input type="text" name="judul_pengumuman" value="<?php echo $data['judul_pengumuman'] ?>" class="form-control">
                </div>
              </div>
            </div>
            <div class="form-group">
              <div class="row align-items-center">
                ...
                <div class="col-sm-10">
                  <textarea rows="10" class="ckeditor" id="editor-custom" name="isi_pengumuman"><?php echo $data['isi_pengumuman']; ?></textarea>
                </div>
              </div>
            </div>
