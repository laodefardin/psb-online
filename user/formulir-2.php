        ...
        <div class="row">
         <!--  <?php 
          ...
          foreach ($query as $data) {
            ?> -->
            <div class="col-lg-12">
              <form action="proses.php" method="post" class="card">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="nama_lengkap" class="form-control" placeholder="Nama Sesuai Ijasah" value="" > 
                      </div>
                    </div>
                    <div class="col-sm-3 col-md-3">
                      <div class="form-group">
                   ...
                   <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="nisn" class="form-control" placeholder="Nomor NISN" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">NIK/No. KITAS<span style="color:red;"> *</span></label>
                      <input type="text" name="nik" class="form-control" placeholder="isi nomor NIK atau Nomor Kitas" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" placeholder="Contoh 14-07-1996" name="tanggal_lahir" value="" class="form-control" >
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                      <label class="form-label">No. Registasi Akta Lahir<span style="color:red;"> *</span></label>
                      <input type="text" placeholder="No. Registasi Akta Lahir" name="no_akta" value="" class="form-control" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="alamat" class="form-control" placeholder="Alamat Jalan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="dusun" class="form-control" placeholder="Isi nama dusun" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Nama Kelurahan / Desa<span style="color:red;"> *</span></label>
                      <input type="text" name="kelurahan" class="form-control" placeholder="Isi nama kelurahan/desa" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Kecamatan<span style="color:red;"> *</span></label>
                      <input type="text" name="kecamatan" class="form-control" placeholder="Isi kecamatan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Kode Pos<span style="color:red;"> *</span></label>
                      <input type="text" name="kode_pos" class="form-control" placeholder="Isi kode pos" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="tempat_tinggal" class="form-control" placeholder="Isi tempat tinggal" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Moda Transportasi<span style="color:red;"> *</span></label>
                      <input type="text" name="moda_transpor" class="form-control" placeholder="Isi Moda Transportasi" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="anak_ke" class="form-control" placeholder="Isi Moda Transportasi" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_ayah" class="form-control" placeholder="Isi Nama Ayah Kandung" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> NIK Ayah<span style="color:red;"> *</span></label>
                      <input type="text" name="nik_ayah" class="form-control" placeholder="Isi NIK Ayah" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Tahun Lahir<span style="color:red;"> *</span></label>
                      <input type="text" name="thn_lahir_ayah" class="form-control" placeholder="Isi Tahun Lahir" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Pendidikan<span style="color:red;"> *</span></label>
                      <input type="text" name="pendidikan_ayah" class="form-control" placeholder="Isi Pendidikan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Pekerjaan<span style="color:red;"> *</span></label>
                      <input type="text" name="pk_ayah" class="form-control" placeholder="Isi Pekerjaan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="hp_ayah" class="form-control" placeholder="Isi No Hape Ayah" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_ibu" class="form-control" placeholder="Isi Nama Ibu Kandung" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> NIK Ibu<span style="color:red;"> *</span></label>
                      <input type="text" name="nik_ibu" class="form-control" placeholder="Isi NIK Ibu" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Tahun Lahir<span style="color:red;"> *</span></label>
                      <input type="text" name="thn_lahir_ibu" class="form-control" placeholder="Isi Tahun Lahir" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Pendidikan <span style="color:red;"> *</span></label>
                      <input type="text" name="pendidikan_ibu" class="form-control" placeholder="Isi Pendidikan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Pekerjaan  <span style="color:red;"> *</span></label>
                      <input type="text" name="pk_ibu" class="form-control" placeholder="Isi Pekerjaan" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                  ...
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> No. Hp. Yang Dapat Dihubungi<span style="color:red;"> *</span></label>
                      <input type="text" name="hp_ibu" class="form-control" placeholder="Isi Nomor Hape Ibu" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Nama Wali<span style="color:red;"> *</span></label>
                      <input type="text" name="nama_wali" class="form-control" placeholder="Isi Nama Wali" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> NIK Wali<span style="color:red;"> *</span></label>
                      <input type="text" name="nik_wali" class="form-control" placeholder="Isi NIK Wali" value="" >
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                ...
                <div class="row">
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      ...
                      <input type="text" name="tinggi_bdn" class="form-control" placeholder="Isi Tinggi Badan" value="">
                    </div>
                  </div>         
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label"> Berat Badan<span style="color:red;"> *</span></label>
                      <input type="text" name="berat_badan" class="form-control" placeholder="Isi Berat Badan" value="">
                    </div>
                  </div> 
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Jumlah Saudara Kandung<span style="color:red;"> *</span></label>
                      <input type="text" name="jml_saudara" class="form-control" placeholder="Jumlah Saudara" value="">
                    </div>
                  </div>
                  <div class="col-sm-3 col-md-3">
                    <div class="form-group">
                      <label class="form-label">Waktu Tempuh Ke sekolah ( Jam / Menit)<span style="color:red;"> *</span></label>
                      <input type="text" name="wkt_tempuh" class="form-control" placeholder="Isi Waktu Tempuh Ke Sekolah" value="">
                    </div>
                  </div>
                  <div class="col-sm-6 col-md-6">
                    <div class="form-group">
                      <label class="form-label"> Jarak Tempat Tinggal Ke sekolah (Sebutkan Dalam Kilometer )<span style="color:red;"> *</span></label>
                      <input type="text" name="jarak_tmpt" class="form-control" placeholder="Isi Jarak" value="">
                    </div>
                  </div>
